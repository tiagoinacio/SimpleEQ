...
void SimpleEQAudioProcessor::updatePeakFilter(const ChainSettings &chainSettings)
{
  ...
  updateCoefficients(leftChain.get<ChainPositions::Peak>().coefficients, peakCoeficients);
  updateCoefficients(rightChain.get<ChainPositions::Peak>().coefficients, peakCoeficients);
}
